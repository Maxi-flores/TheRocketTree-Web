...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: jnMieTswKcwr/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__iwWys)}>
        <div className={classNames(projectcss.all, sty.freeBox__vdQSc)} />
      </div>
      {renderPlasmicSlot({
