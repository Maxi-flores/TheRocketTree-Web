...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: b-Fula1D82Wm/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames(projectcss.all, sty.freeBox__lgUtv)}>
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__sfqRn)}>
        <div
