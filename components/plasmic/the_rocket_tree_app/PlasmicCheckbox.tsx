...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: Vwcb892sVF26/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: 10oF8gUckR9f/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: _X2Y8uXQ2Mwl/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__r2O9G)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__h0OaV)}
            role={"img"}
          />
        ) : null}
      </div>
