...
import Label from "../../Label"; // plasmic-import: Jg5HguLAX4at/component
import TextInput from "../../TextInput"; // plasmic-import: zs9VEljj2SpV/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: vVaSoeTQ_YYw/component
import Description from "../../Description"; // plasmic-import: -hVTb4JscKx3/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: Dsk2qaT17KkG/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__vIDg0, {
          [sty.freeBoxiconEnd__vIDg0AUqTo]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__vIDg0Hu4Ph]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__vIDg0R7KkG]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__ttczy, {
            [sty.freeBoxiconStart__ttczyHu4Ph]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__ttczyr7KkG]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___4DDvf)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__qu0Qo, {
            [sty.freeBoxiconEnd__qu0QoAUqTo]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__qu0QoHu4Ph]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__hMyQu)}
                role={"img"}
              />
            ),
