...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: CoXdvSeo-tam/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: zVXhaqdFiKsJ/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__dUsLp)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__qZ0L4)}
            label={"Open Popover"}
          />
        ),
