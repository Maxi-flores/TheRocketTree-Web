...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: gL-Vce5KSG5y/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__gkGj9)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__hwML)}>
            <div
              className={classNames(
                projectcss.all,
