...
import Checkbox from "../../Checkbox"; // plasmic-import: Vwcb892sVF26/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: xk6-Hc36ydNf/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__ftUZ)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__g9QW)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__fcYn5)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__xGwa)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
