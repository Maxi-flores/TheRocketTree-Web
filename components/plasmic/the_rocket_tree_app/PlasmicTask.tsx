...
import sty from "./PlasmicTask.module.css"; // plasmic-import: 5AHztNUdUimw/css
...
function PlasmicTask__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__hfLz6, {
          [sty.freeBoxglobal_theme_dark_state_editing__hfLz6DjUblBIzg0]:
            hasVariant($state, "state", "editing") &&
            hasVariant(globalVariants, "theme", "dark"),
          [sty.freeBoxstate_editing__hfLz6BIzg0]: hasVariant(
            $state,
            "state",
            "editing"
          )
      ...
      >
        {(hasVariant($state, "state", "editing") ? false : true) ? (
          <div
            className={classNames(projectcss.all, sty.freeBox__wdX4Q, {
              [sty.freeBoxstate_checked__wdX4Q7KpSf]: hasVariant(
                $state,
                "state",
                "checked"
              ),
              [sty.freeBoxstate_checked_global_theme_dark__wdX4Q7KpSfDjUbl]:
                hasVariant($state, "state", "checked") &&
                hasVariant(globalVariants, "theme", "dark"),
              [sty.freeBoxstate_editing__wdX4QbIzg0]: hasVariant(
                $state,
                "state",
                "editing"
              )
            ...
            onClick={async event => {
              ...
              $steps["postgresUpdateMany"] = true
                ? (() => {
                    const actionArgs = {
                      dataOp: {
                        sourceId: "dqWdPEaKnKugmXfGcgdice",
                        opId: "05cb8ff8-c90a-418f-8cc8-e327213dcd29",
                        userArgs: {
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__cOech, {
          [sty.freeBoxglobal_theme_dark__cOechDjUbl]: hasVariant(
            globalVariants,
            "theme",
            "dark"
          ),
          [sty.freeBoxglobal_theme_dark_state_editing__cOechDjUblBIzg0]:
            hasVariant($state, "state", "editing") &&
            hasVariant(globalVariants, "theme", "dark"),
          [sty.freeBoxstate_editing__cOechbIzg0]: hasVariant(
            $state,
            "state",
            "editing"
          )
      ...
      >
        {(hasVariant($state, "state", "editing") ? false : true) ? (
          <div
            className={classNames(projectcss.all, sty.freeBox__uMJi, {
              [sty.freeBoxstate_checked__uMJi7KpSf]: hasVariant(
                $state,
                "state",
                "checked"
              ),
              [sty.freeBoxstate_editing__uMJIbIzg0]: hasVariant(
                $state,
                "state",
                "editing"
              )
                ...
                $steps["tutorialdbUpdateMany"] = true
                  ? (() => {
                      const actionArgs = {
                        dataOp: {
                          sourceId: "dqWdPEaKnKugmXfGcgdice",
                          opId: "c24f4208-96ee-4847-b0b0-86dd5d5d1cdb",
                          userArgs: {
                            conditions: [$props.task.id],
              ...
              $steps["postgresUpdateMany"] = true
                ? (() => {
                    const actionArgs = {
                      dataOp: {
                        sourceId: "dqWdPEaKnKugmXfGcgdice",
                        opId: "e878f433-758f-41e2-96cc-8356263c1dcf",
                        userArgs: {
                          variables: [$state.textbox.value],
        ...
        {(hasVariant($state, "state", "editing") ? false : true) ? (
          <div
            className={classNames(projectcss.all, sty.freeBox___0E7Cp, {
              [sty.freeBoxstate_editing___0E7CpbIzg0]: hasVariant(
                $state,
                "state",
                "editing"
              )
                ...
                $steps["postgresDeleteMany"] = true
                  ? (() => {
                      const actionArgs = {
                        dataOp: {
                          sourceId: "dqWdPEaKnKugmXfGcgdice",
                          opId: "3d02af2c-b584-4600-a97e-5321eea8bad1",
                          userArgs: {
                            conditions: [$props.task.id]
                          },
                          cacheKey: null,
