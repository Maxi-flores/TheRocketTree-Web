...
import SliderThumb from "../../SliderThumb"; // plasmic-import: i0UO6GAfeXdQ/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: _1O-6S3PusKE/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__xVd6N)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__wz2T6)}>
        <div
