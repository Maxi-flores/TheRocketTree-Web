...
import Radio from "../../Radio"; // plasmic-import: jnMieTswKcwr/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: XCXlfP9A2aV8/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__anupz)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__nTu0R)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__zB6C4)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio___65Gdn)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
